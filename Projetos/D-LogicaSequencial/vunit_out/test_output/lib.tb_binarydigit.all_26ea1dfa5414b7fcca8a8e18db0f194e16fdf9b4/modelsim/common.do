...
proc vunit_compile {} {
    ...
    set chan [open |[list {/usr/bin/python3} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['/usr/bin/python3', '-u', 'testeLogicaSequencial.py', '--compile'], cwd='/home/borg/Desktop/Z01.1-F-5judeus2ateu/Projetos/D-LogicaSequencial', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
