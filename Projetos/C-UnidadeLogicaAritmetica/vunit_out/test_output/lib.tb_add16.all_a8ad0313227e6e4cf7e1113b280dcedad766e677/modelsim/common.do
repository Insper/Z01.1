...
proc is_test_suite_done {} {
    set fd [open "/home/borg/Documents/Insper/Elementos/Z01.1-Centaur/Projetos/C-UnidadeLogicaAritmetica/vunit_out/test_output/lib.tb_add16.all_a8ad0313227e6e4cf7e1113b280dcedad766e677/vunit_results" "r"]
...
proc vunit_compile {} {
    ...
    set chan [open |[list {/usr/bin/python3} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['/usr/bin/python3', '-u', 'testeULA.py', '--compile'], cwd='/home/borg/Documents/Insper/Elementos/Z01.1-Centaur/Projetos/C-UnidadeLogicaAritmetica', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
