...
begin
	...
	HEX0 <= "0000001" when SW (9 downto 8) = "00" else
	...
	HEX1 <= "0000001" when SW (7 downto 4) = "0000" else
				...
				"0000100" when SW (7 downto 4) = "1001" else
				"0000010" when SW (7 downto 4) = "1010" else
	...
	HEX2 <= "0000001" when SW (3 downto 0) = "0000" else
				...
				"0000100" when SW (3 downto 0) = "1001" else
				"0000010" when SW (3 downto 0) = "1010" else
